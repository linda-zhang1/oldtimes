console.log("controlRect in version2 has called");
...
class ControlRect{
    ...
    mUp(e){
        ...
        if(this.startInBounds == true && this.endInBounds == true){
            var myObject = new basicRect(this.xMouseStart,this.yMouseStart,this.w,this.h,colArray[2][0]);
