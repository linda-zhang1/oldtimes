...
class ControlShapes{
    ...
    constructor(canvas,x,y,wid,heg,fill){
        ...
        // change the line width of the line button - default width
        this.lw = 5;
    ...
    mUp(e){
        ...
        // enable the removal of the last shape drawin on the canvas

        if(this.shape == "Undo"){
            this.objectSet.pop();
            this.shape = "";
        }
        // enable the user to clear the entire rectangle drawing canvas
        else if(this.shape == "Clear"){
            this.objectSet = [];
            this.shape = "";
        }
        ...
        if(this.startInBounds == true && this.endInBounds == true){
            ...
            if(this.shape == "Rectangle"){
                ...
                var myShape = new BasicLine(this.xMouseStart,this.yMouseStart,this.xMouse,this.yMouse,this.dragFill,this.lw);
                this.objectSet.push(myShape);
            }
    ...
    // to change the line width of the line button
    // refer to lineWidthButton.js
    setLineWidth(u){
        this.lw = u;
    }
    ...
    update(){
        ...
        // this enables the circle and star to fit in bounds
        ctx.clip();
        ...
        // draw the swatch indication
        this.drawCircle(this.xCircle,this.yCircle,this.rCircle,this.dragFill);
    }
    ...
    draw(){
        ...
        if(this.shape == "Rectangle"){
            ...
            this.drawLine(this.xMouseStart,this.yMouseStart,this.xMouse,this.yMouse,this.lw);
        }
        else if(this.shape == "Animated Circle"){
